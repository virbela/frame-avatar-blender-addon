...
def select_objects_by_uv(
    ...
    set_selection(
        view_layer.objects, *to_select, synchronize_active=True, make_sure_active=True
    )
...
def synchronize_mirrors(
    ...
    for mirror in ht.bake_target_mirror_collection:
        ...
        if primary and secondary:
            ...
            copy_collection(
                primary.variant_collection,
                secondary.variant_collection,
                transfer_variant,
            )
...
class FABA_OT_synchronize_visibility_to_render(FabaOperator):
    ...
    bl_description = (
        "Will only make objects that are going to be rendered visible in the viewlayer"
    )
...
class FABA_OT_synchronize_mirrors(FabaOperator):
    ...
    bl_description = (
        "Copy settings from all primary targets to secondary targets in the mirror list"
    )
