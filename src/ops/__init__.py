...
# Introduction
class FABA_OT_setup_bake_scene(frame_operator):
...
# Export
class FABA_OT_export(frame_operator):
...
# Bake Targets
class FABA_OT_create_targets_from_avatar(frame_operator):
...
# Work Meshes
class FABA_OT_create_workmeshes_for_all_targets(frame_operator):
...
class FABA_OT_create_workmeshes_for_selected_target(frame_operator):
...
class FABA_OT_update_selected_workmesh_all_shapekeys(frame_operator):
...
class FABA_OT_update_selected_workmesh_active_shapekey(frame_operator):
...
class FABA_OT_update_selected_workmesh(frame_operator):
...
class FABA_OT_update_all_workmeshes(frame_operator):
...
class FABA_OT_workmesh_to_shapekey(frame_operator):
...
class FABA_OT_all_workmeshes_to_shapekeys(frame_operator):
...
class FABA_OT_shapekey_to_workmesh(frame_operator):
...
class FABA_OT_all_shapekey_to_workmesh(frame_operator):
...
class FABA_OT_workmesh_symmetrize(frame_operator):
...
class FABA_OT_mirror_workmesh_verts(frame_operator):
...
# Texture Atlas
class FABA_OT_auto_assign_atlas(frame_operator):
...
class FABA_OT_pack_uv_islands(frame_operator):
...
# Work Materials
class FABA_OT_update_selected_material(frame_operator):
...
class FABA_OT_update_all_materials(frame_operator):
...
class FABA_OT_switch_to_bake_material(frame_operator):
...
class FABA_OT_switch_to_preview_material(frame_operator):
...
class FABA_OT_select_by_atlas(frame_operator):
...
class FABA_OT_set_selected_workmesh_atlas(frame_operator):
...
# Baking
class FABA_OT_bake_selected_bake_target(frame_operator):
...
class FABA_OT_bake_selected_workmeshes(frame_operator):
...
class FABA_OT_bake_all(frame_operator):
...
# Helpers
class FABA_OT_synchronize_uv_to_vertices(frame_operator):
...
class FABA_OT_select_objects_by_uv(frame_operator):
...
class FABA_OT_synchronize_visibility_to_render(frame_operator):
...
class FABA_OT_make_everything_visible(frame_operator):
...
class FABA_OT_reset_uv_transforms(frame_operator):
...
class FABA_OT_recalculate_normals(frame_operator):
...
class FABA_OT_update_baking_scene(frame_operator):
...
class FABA_OT_synchronize_mirrors(frame_operator):
...
class FABA_OT_copy_uv_layers(frame_operator):
...
class FABA_OT_add_bake_target(frame_operator):
...
class FABA_OT_show_selected_bt(frame_operator):
...
class FABA_OT_remove_bake_target(frame_operator):
...
class FABA_OT_add_bake_target_variant(frame_operator):
    bl_label =            "+"
    bl_description =      'Add variant'
    bl_idname =           'faba.add_bake_target_variant'
    frame_operator =      operations.bake_variants.add

class FABA_OT_remove_bake_target_variant(frame_operator):
    bl_label =            "-"
...
class FABA_OT_set_bake_mirror_primary(frame_operator):
...
class FABA_OT_set_bake_mirror_secondary(frame_operator):
...
class FABA_OT_remove_bake_group_member(frame_operator):
    bl_label =            "-"
...
class FABA_OT_remove_position_effect(frame_operator):
    bl_label =            "-"
...
class FABA_OT_add_position_effect(frame_operator):
    bl_label =            "+"
...
class FABA_OT_remove_color_effect(frame_operator):
    bl_label =            "-"
...
class FABA_OT_add_color_effect(frame_operator):
    bl_label =            "+"
...
class FABA_OT_clear_bake_scene(frame_operator):
...
class FABA_OT_clear_bake_targets(frame_operator):
...
class FABA_OT_show_bone_debug(frame_operator):
